...
public class Create_dipendency {
	WebDriver driver;
	...
	@Test(dependsOnMethods = "open")        //it decleared that login method depends on open mehod
	public void login() {
		...
		Assert.fail();                     //it is uesd to intentionally fail the method to execute
	}

	@Test(dependsOnMethods = "login")         //it decleared that leave method depends on Lo gin mehod
	public void leave() {
