...
public class CenterID_HSSLC {
	public static void main(String[] args) throws AWTException, InterruptedException {
		System.setProperty("webdriver.chrome.driver", "./softwares/chromedriver.exe");
		WebDriver driver = new ChromeDriver();
		driver.manage().window().maximize();
		driver.manage().timeouts().implicitlyWait(20, TimeUnit.SECONDS);
		driver.get("https://mbose-hsslc.getmyresult.in/login.aspx");

		driver.findElement(By.id("txtusercode")).sendKeys("RPSS0069");
		driver.findElement(By.id("txtpassword")).sendKeys("GRE342QGRH");
		Thread.sleep(4000);
...
//        int expectedOptionCount = Integer.parseInt(CenterID_generic.ddt("HSSLC", y, 0));
		...
		for (int r = 0; r <154; r++) {
			String expectedOptionCountStr = CenterID_generic.ddt("hSSLC", y, 0);
...
//			int expectedOptionCount = (int) Math.round(expectedOptionCountDouble);
			...
			String Center_code = CenterID_generic.ddt("HSSLC", y, 3);
