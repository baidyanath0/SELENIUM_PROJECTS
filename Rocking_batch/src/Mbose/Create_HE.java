...
//		for (int r = 0; r < 100;r++) {
		...
		driver.findElement(By.xpath("//div[text()='Head Examiner']")).click();
		int x = 0;
		String sub = Create_HE_Generic.ddt("Sheet1", x, 0); // (row,cell)
		String F_name = Create_HE_Generic.ddt("Sheet1", x, 1);
		String L_name =Create_HE_Generic.ddt("Sheet1", x, 2);
		String ph = Create_HE_Generic.ddt("Sheet1", x, 3);
		for (int r = 0; r < 1;r++) {
		driver.findElement(By.xpath("//a[@href='create-headexaminer.aspx']")).click();
